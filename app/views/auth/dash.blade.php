    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Mi proyecto 1</a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li id="liDashboard" class="active lis" onclick="addClassActive('liDashboard');showView('main','ocultar')"><a href="#">Dashboard <span class="sr-only">(current)</span></a></li>
            <li id="liBlog" class="lis" onclick="addClassActive('liBlog');showView('idBlog','ocultar')"><a href="#">Blog</a></li>
            <li id="liSocial" class="lis" onclick="addClassActive('liSocial');showView('idSocial','ocultar')"><a href="#">Social Networking</a></li>
            <li id="liFavorites" class="lis" onclick="addClassActive('liFavorites');showView('idFavoritos','ocultar')"><a href="#">favorites</a></li>
            <li id="liRecommended" class="lis" onclick="addClassActive('liRecommended')"><a href="#">Recommended</a></li>
            <li id="liAssignTask" class="lis" onclick="addClassActive('liAssignTask');showView('idAssignTask','ocultar')"><a href="#">Assign Task</a></li>
        ...
        <div id="idBlog" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 ocultar" style="display:none" >
          <div class="col-md-4 col-md-offset-4">idBlog
          </div>
        </div>  

        <div id="idSocial" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 ocultar" style="display:none" >
          <div class="col-md-4 col-md-offset-4">idSocial
          </div>
        </div>

        <div id="idFavoritos" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 ocultar" style="display:none" >
          <div class="col-md-4 col-md-offset-4">idFavorites
          </div>
        </div> 

              

      <section id="idAssignTask" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 ocultar spin" style="display:none" >    
                ...
                <div class="col-md-8 col-md-offset-2">
                  <div class="panel panel-default">
                    <div class="panel-body">
                      ...
                      {{ Form::open(['route' => 'assignTask', 'method' => 'POST', 'role' => 'form','files' => true]) }}
